...
\begin{abstract}
  ...
  swarms. The proposed policies are chain and hypercubic topologies and compare
...
the new communication policies. Essentially, functions 1, 10, and 15
...
of fact, the only significantly better result occurs with the original
EvoSwarm in the case of the ellipsoidal function.
