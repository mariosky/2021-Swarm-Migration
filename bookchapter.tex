...
and parallel execution of these kind of algorithms, % Aqui comenta algunos otros brevemente 
% con referencias - M 
% Conector: 
...
was introduced in 1995, it has undergone several improvements.\cite{b1} % pon el nombre del autor - M 
