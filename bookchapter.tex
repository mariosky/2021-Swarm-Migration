...
\begin{abstract}
  ...
  between them asynchronously. However, the design % Which aspect of
                                % the design? - JJ
  of these systems is not a
  trivial task because any architectural options will affect how the
